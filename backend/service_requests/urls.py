...
from .views import (
    ...
    AdminACRateCardListView,
    AdminACRateCardDetailView,
    AdminACRateCardResetDefaultsView,
...
urlpatterns = [
    ...
    path("booking/multi/",                   MultiServiceBookingCreateView.as_view(), name="sr-booking-multi"),
    ...
    path('admin/ac/rate-card/',                          AdminACRateCardListView.as_view(),             name='admin-ac-rate-card-list'),
    path('admin/ac/rate-card/<int:pk>/',                 AdminACRateCardDetailView.as_view(),           name='admin-ac-rate-card-detail'),
    path('admin/ac/rate-card/reset-defaults/',           AdminACRateCardResetDefaultsView.as_view(),     name='admin-ac-rate-card-reset'),
