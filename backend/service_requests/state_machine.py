...
ALLOWED_TRANSITIONS = {
    ...
    S.ASSIGNED:               {S.ACCEPTED, S.REJECTED, S.CANCELLED, S.RESCHEDULED, S.FEEDBACK_RECEIVED},
    S.ACCEPTED:               {S.ON_THE_WAY, S.IN_PROGRESS, S.CANCELLED, S.FEEDBACK_RECEIVED},
    S.ON_THE_WAY:             {S.IN_PROGRESS, S.CANCELLED, S.FEEDBACK_RECEIVED},
