...
def _matches_service_slug(requested_slug: str, candidate_slug: str, candidate_name: str = "") -> bool:
    ...
    ALIASES = {
        ...
        "appliances": {"ac-service-cleaning", "ac-repair", "ac-gas-refill", "ac-installation", "refrigerator", "washing-machine", "tv-display", "microwave", "ac-appliance", "ac"},
        "appliance": {"ac-service-cleaning", "ac-repair", "ac-gas-refill", "ac-installation", "refrigerator", "washing-machine", "tv-display", "microwave", "ac-appliance", "ac"},
        "hvac": {"ac-service-cleaning", "ac-repair", "ac-gas-refill", "ac-installation", "ac", "ac-appliance"},
