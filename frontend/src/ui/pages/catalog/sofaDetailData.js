...
export const SOFA_DETAIL_DATA = {
  "quick-fan-clean": {
    ...
    ready: ["Ensure space directly below the fan is clear", "Provide access to a power source"],
    reviews: [
      ...
      { name: "Rohan V.", rating: "4.9", text: '"Very neat and quick. The blades look clean now."' },
      { name: "Suresh P.", rating: "5.0", text: '"Removed all sticky dust from the motor casing too. Excellent service."' },
      { name: "Kunal D.", rating: "4.7", text: '"Technician was polite and cleaned up the floor after finishing."' }
    ],
    faqs: [
  ...
  "quick-door-clean": {
    tools: ["Wood-safe spray", "Soft detailing sponges", "Microfiber towels"],
    ready: ["Provide clear path to doors"],
    reviews: [
      ...
      { name: "Meera H.", rating: "5.0", text: '"Door frames and panels look brand new. Removed all fingerprint marks."' },
      { name: "Rajesh T.", rating: "4.9", text: '"Prompt service. Handles and locks were sanitized thoroughly."' },
      { name: "Pooja A.", rating: "4.8", text: '"Very nice scrubbing of the bathroom door. All water scales are gone."' }
    ],
    faqs: [
  ...
  "fridge-clean": {
    ...
    reviews: [
      ...
      { name: "Preeti M.", rating: "4.9", text: '"Cleaned every tray and container. Removed all stale food odor completely."' },
      { name: "Sanjay B.", rating: "5.0", text: '"Extremely professional. Defrosted the freezer and washed all baskets."' },
      { name: "Nisha F.", rating: "4.7", text: '"Detailed cleaning. Left the stainless steel exterior looking shiny and clean."' }
    ],
    faqs: [
  ...
  "quick-balcony-above-4ft": {
    tools: ["Floor scrubbers", "High pressure water sprays", "Hard dusting brushes", "Mesh cleaning brushes"],
    ready: ["Remove plants or outdoor furniture from the balcony", "Ensure access to a water connection"],
    reviews: [
      ...
      { name: "Gaurav S.", rating: "5.0", text: '"Outstanding job on the glass railings. Both sides are crystal clear."' },
      { name: "Sneha W.", rating: "4.9", text: '"Cleared all old mud stains from the corners. Highly recommended."' },
  ...
  "fabric-sofa-clean": {
    tools: ["Fabric-safe cleaning shampoo", "Microfiber cloths", "Soft cleaning brushes", "Wet & dry vacuum"],
    ready: ["Keep the sofa area accessible", "Remove personal items from the sofa", "Keep nearby furniture and valuables safely away", "Provide a power connection"],
    reviews: [
      ...
      { name: "Suresh B.", rating: "4.9", text: '"Highly recommended. Removed all tea and ink stains from fabric."' },
      { name: "Divya N.", rating: "5.0", text: '"Sofa feels super fresh and smells great after the shampoo wash."' },
      { name: "Kiran R.", rating: "4.7", text: '"Professional wet vacuuming. Sofa dried up quickly under the fan."' }
    ],
    faqs: [
  ...
  "fabric-sofa-cushion-clean": {
    tools: ["Fabric-safe cleaning shampoo", "Microfiber cloths", "Soft cleaning brushes", "Wet & dry vacuum"],
    ready: ["Keep the sofa and cushions accessible", "Remove personal items from the sofa", "Keep nearby furniture and valuables safely away", "Provide a power connection"],
    reviews: [
      ...
      { name: "Nitin P.", rating: "5.0", text: '"Cleaned all 5 seats and 4 extra loose cushions. Spotless finish."' },
      { name: "Rashmi S.", rating: "4.8", text: '"The shampoo foam treatment removed deep dust from cushion covers."' },
      { name: "Vikram G.", rating: "4.9", text: '"Great experience. Sofa and cushions smell nice and fresh."' }
    ],
    faqs: [
  ...
  "leather-sofa-clean": {
    tools: ["Leather-safe cleaning solution", "Leather conditioner", "Soft microfiber cloths", "Soft cleaning brushes"],
    ready: ["Keep the sofa area accessible", "Remove personal items from the sofa", "Keep valuables safely away", "Provide a well-ventilated area"],
    reviews: [
      ...
      { name: "Manish R.", rating: "4.9", text: '"Applied leather conditioner beautifully. The sofa has a nice shine now."' },
      { name: "Pooja V.", rating: "5.0", text: '"No strong chemical smell. Cleaned all dirt from leather corners."' },
      { name: "Deepak S.", rating: "4.8", text: '"Professional service. Leather surface feels soft and looks shiny."' }
    ],
    faqs: [
  ...
  "leather-sofa-cushion-clean": {
    tools: ["Leather-safe cleaning solution", "Leather conditioner", "Soft microfiber cloths", "Soft cleaning brushes"],
    ready: ["Keep the sofa and cushions accessible", "Remove personal items from the sofa", "Keep valuables safely away", "Provide a well-ventilated area"],
    reviews: [
      ...
      { name: "Sandeep J.", rating: "5.0", text: '"Cleaned all loose leather cushions and backrests. Polish is awesome."' },
      { name: "Anita G.", rating: "4.9", text: '"Excellent leather conditioning. Removed all armrest grease marks."' },
      { name: "Ritu M.", rating: "4.8", text: '"Prompt and polite staff. The leather sofa looks brand new."' }
    ],
    faqs: [
  ...
  "mattress-deep": {
    tools: ["Fabric-safe mattress shampoo", "Wet & dry vacuum", "Microfiber cloths", "Soft cleaning brushes"],
    ready: ["Keep the mattress accessible", "Remove bedsheets, pillows and blankets", "Keep nearby items safely away", "Provide a power connection"],
    reviews: [
      ...
      { name: "Abhishek T.", rating: "5.0", text: '"Removed tough coffee stains from the mattress. Excellent vacuuming."' },
      { name: "Sunil L.", rating: "4.9", text: '"Shampoo wash removed all bad odor. Mattress feels very clean."' },
      { name: "Nidhi B.", rating: "4.7", text: '"Professional wet extraction. Took a few hours to dry but looks fresh."' }
    ],
    faqs: [
  ...
  "mattress-pillow-refresh": {
    tools: ["Fabric-safe cleaning products", "Wet & dry vacuum", "Microfiber cloths", "Soft cleaning brushes"],
    ready: ["Remove bedsheets and covers", "Keep mattress and pillows accessible", "Clear the surrounding area", "Provide a power connection"],
    reviews: [
      ...
      { name: "Rajesh P.", rating: "5.0", text: '"Superb mattress and pillow sanitization. Dust allergy is gone."' },
      { name: "Neeta G.", rating: "4.8", text: '"Thoroughly vacuumed pillows and bed surface. Very professional."' },
      { name: "Kunal J.", rating: "4.9", text: '"Good foam shampoo cleaning. Smells clean and fresh now."' }
    ],
    faqs: [
  ...
  "carpet-deep": {
    tools: ["Carpet shampoo", "Wet & dry vacuum", "Microfiber cloths", "Sponge scrubbers"],
    ready: ["Keep the carpet area accessible", "Clear any furniture on top of the carpet", "Provide a power connection"],
    reviews: [
      ...
      { name: "Vikas A.", rating: "4.9", text: '"Extracted black water from our dirty carpet. Looks bright again."' },
      { name: "Tanvi S.", rating: "5.0", text: '"Great stain removal. Food drops on the living room carpet are gone."' },
      { name: "Gopal R.", rating: "4.7", text: '"Technicians were polite and did a detailed scrubbing job."' }
    ],
    faqs: [
