...
export function AntsBedBugsControlModal({ category, cart, setCart, onClose, onCheckout }) {
  ...
  const filteredBedbugs = filterList(PEST_SERVICES.bedbugs);
  const filteredAntsKB = filterList(PEST_SERVICES.ants_kitchen_bathroom);
  const filteredAntsAB = filterList(PEST_SERVICES.ants_apartment_bungalow);
