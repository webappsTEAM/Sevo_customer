...
const SERVICE_DETAILS_CONTENT = {
  ...
  "pest-apt-main": {
    ...
    faqs: [
      { q: "How long does the effect last?", a: "The treatment is designed to prevent pest return for up to 90 days. A second visit at 14 days is included to ensure complete eradication." }
    ]
  },
  "pest-bung-main": {
    rates: [
