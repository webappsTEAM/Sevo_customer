/**
 * assetRegistry.cjs
 * CommonJS export of the asset registry for Node scripts and build checks.
 */
...
const ASSET_REGISTRY = {
  ...
  'prod-air-filter-element': {
    ...
    url: '/mockups/appliance_cleaning_hero.webp',
    alt: 'Atlas Copco Air Filter Element',
  },
  'prod-ir-air-filter': {
    id: 'prod-ir-air-filter',
    url: '/mockups/ac_inspection_clearance_1789211826535.png',
  ...
  'prod-lubricant-oil': {
    ...
    url: '/mockups/1a63e67ba93645d6ac2ee69d599caef8.webp',
  ...
  'hero-banner-main': {
    id: 'hero-banner-main',
    url: '/mockups/groceries_realistic.webp',
    alt: 'Genuine Parts Faster Operations',
  },
  'empty-state-box': {
    id: 'empty-state-box',
